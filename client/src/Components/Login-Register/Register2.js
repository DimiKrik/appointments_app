...
const Register2 = (props) => {
  ...
  const isTelephoneValid = (telephone) => {
    // Check if the telephone number is less than 10 numbers
    return telephone.replace(/[^0-9]/g, "").length < 10;
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      lastName !== "" &&
      telephone !== "" &&
      isTelephoneValid(telephone) && // Check if the telephone is valid
      address !== ""
    ) {
      axios
        .post(
